...
# data
_C.data = edict()
_C.data.dataset_root = "/mnt/sdb/public/data/fyc/gitspace/GeoTransformer/data/3DMatch"
...
_C.eval.fmr_threshold = 0.05

# ransac
_C.ransac = edict()
_C.ransac.distance_threshold = 0.05
_C.ransac.num_points = 3
_C.ransac.num_iterations = 5000
...
_C.geotransformer.sigma_g = 0.3
_C.geotransformer.scales = [1, 5, 25]
_C.geotransformer.k_neighbors = 10
